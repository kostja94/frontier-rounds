...
export const fundingRounds: FundingRound[] = [
  ...
  },
  {
    ...
    date: "2026-09-08",
    country: "United States",
    sector: "AI Coding Agents",
    leadInvestor: "Andreessen Horowitz",
    note: "US$2B Series E at a US$48B valuation led by new investors a16z and Accel — Devin's run-rate revenue nearly doubled from US$492M to ~US$900M since May.",
    slug: "cognition",
    logo: "/logos/conviction-cognition.png",
    sourceUrl: "https://www.reuters.com/technology/cognition-ai-raises-2-billion-48-billion-valuation-2026-09-08/",
  },
  {
    id: "mistral",
    company: "Mistral AI",
  ...
  },
  {
    ...
    leadInvestor: "DST Global",
    note: "US$400M Series B at a US$5.4B valuation led by DST Global — quadrupling its US$1.3B January price in eight months, with US$700M annualized revenue and 30M+ users.",
    slug: "higgsfield",
    logo: "/logos/higgsfield.png",
    sourceUrl: "https://www.prnewswire.com/news-releases/higgsfield-raises-400-million-series-b-financing-at-5-4-billion-valuation-with-annualized-revenue-reaching-700-million-302852430.html",
  },
  {
    id: "unitree",
    company: "Unitree",
